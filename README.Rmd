...
1. Specimen data (standard lenth, photophore areas, lens diameters) that are contained in a single file `eye_PO_data.csv`. 

2. Flux data was modeled on the output of Aristostomias scintillans reported Mensinger and Case (1990, J. of Exp. Mar. Biol. & Ecol. 144:1–15). The data for this study are in `mes.cas.flux.dat.csv`.
